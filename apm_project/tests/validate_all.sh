...
run_interactive_stdin_cases() {
    ...
    assert_path_exists "$tmp_parent/int-codex-rapid/.codex/agents/apm-reviewer.toml" "Codex RAPID reviewer agent file"
    assert_path_exists "$tmp_parent/int-codex-rapid/.codex/agents/apm-memory-bank-sync.toml" "Codex RAPID sync agent file"
    assert_path_exists "$tmp_parent/int-codex-rapid/.codex/agents/apm-web-explorer.toml" "Codex RAPID web-explorer agent file"
    ...
    assert_path_exists "$tmp_parent/int-claude-rapid/.claude/agents/apm-web-explorer.md" "Claude RAPID web-explorer agent file"
...
run_non_interactive_matrix_and_installers() {
    ...
    assert_path_exists "$installer_projects/p1/.codex/agents/apm-reviewer.toml" "codex_install local reviewer agent file"
    assert_path_exists "$installer_projects/p1/.codex/agents/apm-memory-bank-sync.toml" "codex_install local sync agent file"
    assert_path_exists "$installer_projects/p1/.codex/agents/apm-web-explorer.toml" "codex_install local web-explorer agent file"
    assert_path_exists "$installer_projects/p1/.codex/agents/apm-data-scientist.toml" "codex_install local data-scientist agent file"
    ...
    assert_path_exists "$installer_projects/p2/.opencode/agents/apm-web-explorer.md" "opencode_install local web-explorer agent file"
    assert_path_exists "$installer_projects/p2/.opencode/agents/apm-reviewer.md" "opencode_install local reviewer agent file"
    ...
    assert_path_exists "$installer_projects/p4/.claude/agents/apm-reviewer.md" "claude_install local reviewer agent file"
    assert_path_exists "$installer_projects/p4/.claude/agents/apm-team-lead.md" "claude_install local team-lead agent file"
    assert_path_exists "$installer_projects/p4/.claude/agents/apm-web-explorer.md" "claude_install local web-explorer agent file"
