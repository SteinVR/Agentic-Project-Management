---
name: apm-code-reviewer
description: Independent verification and code-review gate. Checks implementation against task scope and architecture, then reports ranked findings. Use proactively after code changes.
