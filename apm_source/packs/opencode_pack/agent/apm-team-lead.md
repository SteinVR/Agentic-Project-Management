---
description: Team Lead primary agent for orchestration-first execution. Orchestrates one or more tasks through specialist subagents, validates results, and returns one final compact handoff.
mode: primary
permission:
  task:
    "apm-*": allow
